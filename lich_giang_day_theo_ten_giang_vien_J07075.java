...
public class lich_giang_day_theo_ten_giang_vien_J07075 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("LICH GIANG DAY GIANG VIEN " + str + ":");
        for(HocPhan x : arr){
            if(x.getNameLec().equals(str)){
                System.out.println(x.getIdHp() + " " + mapMh.get(x.getIdMh()).getName() + " "
                 + x.getDayHp() + " " + x.getAmountLess() + " " + x.getRoom());
            }
        }
    }
}
